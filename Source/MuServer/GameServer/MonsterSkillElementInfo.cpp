...
void CMonsterSkillElementInfo::ApplyElementHP(int aIndex, int bIndex)
{
	...
	GCLifeSend(bIndex, 0xFF, (int)gObj[bIndex].Life);
}
...
void CMonsterSkillElementInfo::ApplyElementNormalAttack(int aIndex, int bIndex)
{
	...
	if (this->m_IncAndDecType != -1 && this->m_IncAndDecValue != -1)
	{
		if (gObj[bIndex].Inventory[9].m_Index != GET_ITEM(this->m_IncAndDecType, this->m_IncAndDecValue) && gObj[bIndex].Inventory[10].m_Index != GET_ITEM(this->m_IncAndDecType, this->m_IncAndDecValue) && gObj[bIndex].Inventory[11].m_Index != GET_ITEM(this->m_IncAndDecType, this->m_IncAndDecValue))
		{
			...
			gObjectManager.CharacterLifeCheck(&gObj[aIndex], &gObj[bIndex], (int)(gObj[bIndex].MaxLife + gObj[bIndex].AddLife), 0, 0, DAMAGE_TYPE_NORMAL, 0);
	...
	if (this->m_NullifiedSkill < 1)
	{
		gAttack.Attack(&gObj[aIndex], &gObj[bIndex], 0, 0, 0, 0);
	}
	else
	{
